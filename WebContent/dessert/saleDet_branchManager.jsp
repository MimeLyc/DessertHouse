...
<jsp:useBean id="dessertSale"
	...
	scope="session"></jsp:useBean>  
        ...
        <div class="col-md-6" >	
					  			...
					  			<s:form action="confirmAction" namespace="/DessertHouse">
					                	<table class="table"  style="margin:40px;;width:800px" >
						                		<tr>
						                			<td><h3><%=dessertSale.getName()%></h3></td>
						                			<td></td>
						                		</tr>
						                		<tr>
						                		...
						                		<tr>
						                			<td><h3>用户</h3></td>
						                			<td><input type="text" name="customerID" class="form-control" style="width:30%;" /></td>
						                		</tr>
