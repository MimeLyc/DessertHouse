...
<jsp:useBean id="dessertShopping"
	type="edu.nju.dessertHouse.model.Dessert"
	...
	scope="session"></jsp:useBean>  
        ...
        <div class="col-md-6" >	
					  			...
					  			<s:form action="toConfirm" namespace="/DessertHouse">
					                	<table class="table"  style="margin:40px;;width:800px" >
						                		<tr>
						                			<td><h3><%=dessertShopping.getName()%></h3></td>
						                			<td></td>
						                		</tr>
						                		   <tr>
						                			<td><h3>店面</h3></td>
						                			<td><p style="float:left"><%=shoppingDet.getBranch().getName()%></p></td>
						                		</tr>
						                		<tr>
						                		 ...
						                		 <tr>
						                			<td><h3>数目</h3></td>
						                			<td><input type="text" name="num" class="form-control" style="width:30%;" /></td>
						                		</tr>
						                		<tr>
						                			<td><h3>地址</h3></td>
						                			<td><input type="text" name="address" class="form-control" style="width:30%;" /></td>
						                		</tr>
						                		<tr>
						                			<td><h3>送达日期</h3></td>
						                			<td><input type="date" name="date" class="form-control" style="width:30%;" /></td>
						                		</tr>
