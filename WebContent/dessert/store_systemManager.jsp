								          ...
								          <div class="row">
								            <nav class="templatemo-top-nav col-lg-12 col-md-12">
								              <ul class="text-uppercase">
								                <li  onclick="iframeTransfer('addStore_systemManager.jsp')" style="cursor:pointer"><a>Add Store</a></li>
								          		<li  onclick="iframeTransfer('modify_systemManager.jsp')" style="cursor:pointer"><a>Modify Store</a></li>
								              </ul>  
								            </nav> 
								          </div>
								        </div>
								         ...
								         <div class="templatemo-content-container"  style="padding-bottom:50px">
								      		<div class="templatemo-flex-row flex-content-row"  style="height:100%;width:100%">
								      			<div class="templatemo-content-widget white-bg col-2"  style="height:100%;width:100%">
											        ...
											        <iframe id="mainInf" src="../dessert/addStore_systemManager.jsp"  style="height:400px;width:100%;border:none"></iframe>
							 					     </div>
							           				</div>
								        		</div>
							      </div>
